...
public class TodosResource {
	...
	// and passed to the TodoResources // Allows to type
	// http://localhost:8080/REST_Ex1/rest/todos/1 // 1 will be treaded as parameter
	// todo and passed to TodoResource 
	@Path("{todo}")
